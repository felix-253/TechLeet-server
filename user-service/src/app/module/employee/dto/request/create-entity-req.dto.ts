...
export class CreateEmployeeDto {
   ...
   @IsString()
   @ApiProperty({example: '07 Xô Viết Nghệ Tĩnh, Huyện Hòa Vang, TP. Đà Nẵng', description: 'Address of the employee'})
   address?: string;
   ...
   @Type(() => Date)
   @IsDate()
   @ApiProperty({example: '2023-09-01T00:00:00.000Z', description: 'Confirmation date of the employee'})
   ...
   @IsOptional()
   @IsString()
   @ApiProperty({example: 'https://example.com/avatar.jpg', description: 'Avatar URL of the employee'})
   avatarUrl?: string;
