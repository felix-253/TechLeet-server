...
import { EmployeeEntity } from '@/auth-service/src/entities/master/employee.entity';
import { RedisService } from '@/auth-service/src/configs/redis/redis.service';
import { REDIS_KEY_NEW_EMPLOYEE_OTP } from '@/shared/common/constants/redis-key.constant';
...
export class EmailService {
   ...
   constructor(
      ...
      this.apiInstance.setApiKey(0, this.configService.get('SENDINBLUE_API_KEY') as string);
   }
